...
var budgetController = (function(){
    ...
    var calculateTotal = function (type) {
        var sum = 0;
        data.allItem[type].forEach(function(cur, inx, arr){
            sum+=cur.value;
        });
    ...
    return {
        addItem:function (type, des, val) {
            ...
            //Created new item base on contructor function
            if(type === 'exp'){
        ...
        calculateBudget(){
            ...
            // calculate the persen of income that we spent
...
var UIController = (function(){
    ...
    return {
        ...
        addListItem:function(obj,type){
            ...
            //Replace the placeholder text with some actual datal
        ...
        displayBudget:function (obj) {
            ...
            document.querySelector(DOMstring.budgerLabel).textContent = formatNumber(obj.budget,type);
...
var controller = (function(budgetCtrl,UICtrl){
    ...
    var updatePercentages = function(){
        ...
        // 2.Read percent from the budget controller
